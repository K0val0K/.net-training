...
namespace Task3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var zeroTest = new Rational();
            var normalRational = new Rational(1, 1);
            try
            {
                Console.WriteLine(zeroTest);
                //Console.WriteLine(zeroTest.GetHashCode());
                //Console.WriteLine(normalRational.Equals(zeroTest));
            }
            catch(Exception e)
            {
                Console.WriteLine(e.Message);
